...
const FormacionAdultosMayores = () => (
  <div className="space-y-12">
    <div className="text-center">
      <h2 className="text-3xl font-bold text-zinc-800 mb-6 font-playfair">Cursos para Adultos Mayores</h2>
    ...
    <div className="grid lg:grid-cols-3 gap-8">
      <Card className="group relative overflow-hidden h-full transition-all duration-300 border border-zinc-50 hover:shadow-md">
        <div className="absolute inset-0 bg-gradient-to-br from-amber-25 to-white opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
        <CardContent className="relative z-10 p-8 h-full flex flex-col">
          ...
          <h3 className="text-2xl font-bold mb-4 text-zinc-800 font-playfair">Actividad Física</h3>
          <p className="text-zinc-600 mb-6 text-base leading-relaxed">Ejercicios adaptados para mejorar fuerza, equilibrio y movilidad, diseñados específicamente para adultos mayores.</p>
          <div className="mt-auto">
            <Button className="w-full bg-amber-400 hover:bg-amber-500 text-white transition-all duration-300">
              Más información
            </Button>
          </div>
        </CardContent>
      ...
      <Card className="group relative overflow-hidden h-full transition-all duration-300 border border-zinc-50 hover:shadow-md">
        ...
        <CardContent className="relative z-10 p-8 h-full flex flex-col">
          ...
          <h3 className="text-2xl font-bold mb-4 text-zinc-800 font-playfair">Estimulación Cognitiva</h3>
          <p className="text-zinc-600 mb-6 text-base leading-relaxed">Ejercicios diseñados para mantener la mente ágil, mejorar la memoria y potenciar las funciones cognitivas.</p>
          <div className="mt-auto">
            <Button className="w-full bg-zinc-700 hover:bg-zinc-800 text-white transition-all duration-300">
              Más información
            </Button>
          </div>
        </CardContent>
      ...
      <Card className="group relative overflow-hidden h-full transition-all duration-300 border border-zinc-50 hover:shadow-md">
        ...
        <CardContent className="relative z-10 p-8 h-full flex flex-col">
          ...
          <h3 className="text-2xl font-bold mb-4 text-zinc-800 font-playfair">Actividades Sociales</h3>
          <p className="text-zinc-600 mb-6 text-base leading-relaxed">Talleres y actividades grupales diseñados para fomentar la interacción social y crear conexiones significativas.</p>
          <div className="mt-auto">
            <Button className="w-full bg-amber-400 hover:bg-amber-500 text-white transition-all duration-300">
              Más información
            </Button>
    ...
    <div className="bg-amber-25 p-8 rounded-xl mt-12 border border-amber-100">
      <h3 className="text-2xl font-bold text-center text-zinc-800 mb-8 font-playfair">Beneficios de Nuestros Cursos</h3>
...
const FormacionProfesionales = () => {
  ...
  return (
    <div className="space-y-12">
      <div className="text-center">
        <h2 className="text-3xl font-bold text-zinc-800 mb-6 font-playfair">Formación para Profesionales</h2>
        <p className="text-xl text-zinc-500 max-w-3xl mx-auto leading-relaxed">
      ...
      <div className="grid lg:grid-cols-2 gap-8 max-w-4xl mx-auto">
        <Card className="group relative overflow-hidden h-full transition-all duration-300 border border-zinc-50 hover:shadow-md">
          ...
          <CardContent className="relative z-10 p-8 h-full flex flex-col">
            ...
            <h3 className="text-2xl font-bold mb-4 text-zinc-800 font-playfair">Modalidad Presencial</h3>
            <p className="text-zinc-600 mb-6 text-base leading-relaxed">Clases prácticas con grupos reales para una experiencia de aprendizaje completa y enriquecedora en nuestras instalaciones.</p>
            <div className="mt-auto">
              <Button className="w-full bg-amber-400 hover:bg-amber-500 text-white transition-all duration-300">
                Más información
              </Button>
        ...
        <Card className="group relative overflow-hidden h-full transition-all duration-300 border border-zinc-50 hover:shadow-md">
          ...
          <CardContent className="relative z-10 p-8 h-full flex flex-col">
            ...
            <h3 className="text-2xl font-bold mb-4 text-zinc-800 font-playfair">Certificación Oficial</h3>
            <p className="text-zinc-600 mb-6 text-base leading-relaxed">Obtén la certificación oficial del Método AdulMa y aumenta tus oportunidades laborales en el campo del envejecimiento activo.</p>
            <div className="mt-auto">
              <Button className="w-full bg-zinc-700 hover:bg-zinc-800 text-white transition-all duration-300">
                Más información
              </Button>
      ...
      <div className="max-w-2xl mx-auto">
        <div>
          <h2 className="text-3xl font-bold text-zinc-800 mb-8 font-playfair">Beneficios de la Formación</h2>
          ...
          <div className="bg-amber-25 p-6 rounded-lg border border-amber-100">
            <h3 className="text-xl font-semibold mb-4 text-zinc-800 font-playfair">Inversión y Modalidades</h3>
  ...
  return (
    <div className="pt-32 pb-16 px-4 max-w-7xl mx-auto">
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-bold text-zinc-800 mb-6 font-playfair">Nuestra Formación</h1>
        <p className="text-xl text-zinc-500 max-w-3xl mx-auto leading-relaxed">
      ...
      <div className="bg-white rounded-lg p-8 shadow-lg border border-zinc-50">
        <h2 className="text-3xl font-bold text-center text-zinc-800 mb-8 font-playfair">
        ...
        <form className="max-w-2xl mx-auto space-y-6">
          ...
          {activeTab === 'profesionales' && (
            <div>
              <label htmlFor="profession" className="block text-sm font-medium text-zinc-600 mb-2">
